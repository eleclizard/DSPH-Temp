...
${boundaryvtk} -loadvtk AutoActual -motiondata ${diroutdata} -savevtkdata ${dirout2}/Buckets.vtk -onlymk:12-15 -savevtkdata ${dirout2}/Weel -onlymk:11
if [ $? -ne 0 ] ; then fail; fi
