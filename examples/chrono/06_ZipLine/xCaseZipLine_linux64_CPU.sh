...
${boundaryvtk} -loadvtk ${dirout}/${name}__Dp.vtk -motiondata ${diroutdata} -savevtkdata ${dirout2}/Rope.vtk -onlymk:10 -savevtkdata ${dirout2}/Walls.vtk -onlymk:11 
if [ $? -ne 0 ] ; then fail; fi

${boundaryvtk} -loadvtk AutoActual -motiondata ${diroutdata} -savevtkdata ${dirout2}/Ragdoll -onlytype:floating
if [ $? -ne 0 ] ; then fail; fi
