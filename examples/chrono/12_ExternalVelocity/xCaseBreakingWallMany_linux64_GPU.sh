...
export name=CaseBreakingWallMany
...
${boundaryvtk} -loadvtk ${dirout}/*_Actual.vtk -motiondata ${diroutdata} -savevtkdata ${dirout2}/Domain.vtk -onlymk:10 -savevtkdata ${dirout2}/Ball -onlymk:20 -savevtkdata ${dirout2}/Wall -onlymk:61-172
if [ $? -ne 0 ] ; then fail; fi
