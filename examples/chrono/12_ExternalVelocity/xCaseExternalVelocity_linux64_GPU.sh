...
export name=CaseExternalVelocity
...
${boundaryvtk} -loadvtk ${dirout}/*_Actual.vtk -motiondata ${diroutdata} -savevtkdata ${dirout2}/Domain.vtk -onlymk:20 -savevtkdata ${dirout2}/Boxes -onlymk:63-64 
if [ $? -ne 0 ] ; then fail; fi
