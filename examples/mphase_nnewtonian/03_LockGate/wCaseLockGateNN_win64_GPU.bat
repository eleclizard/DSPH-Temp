...
rem Executes IsoSurface to create VTK files with slices of surface for p1
set dirout2=%dirout%\surface
%isosurface% -dirin %diroutdata% -saveslice %dirout2%/Slices_phase1 -onlymk:1
if not "%ERRORLEVEL%" == "0" goto fail

rem Executes IsoSurface to create VTK files with slices of surface for p2.
set dirout2=%dirout%\surface
