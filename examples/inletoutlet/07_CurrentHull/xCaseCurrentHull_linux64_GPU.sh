...
${boundaryvtk} -loadvtk AutoActual -motiondata ${diroutdata} -savevtkdata ${dirout2}/Box.vtk -onlymk:10 -savevtkdata ${dirout2}/Hull.vtk -onlymk:30
if [ $? -ne 0 ] ; then fail; fi
