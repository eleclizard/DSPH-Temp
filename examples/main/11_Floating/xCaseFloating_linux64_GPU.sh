...
${boundaryvtk} -loadvtk AutoActual -motiondata ${diroutdata} -savevtkdata ${dirout2}/MotionFloating -onlytype:floating -savevtkdata ${dirout2}/MotionPiston -onlytype:moving -savevtkdata ${dirout2}/Box.vtk -onlytype:fixed
if [ $? -ne 0 ] ; then fail; fi
