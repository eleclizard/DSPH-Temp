...
rem change "name" according to the theory you want to simulate
rem set name=CaseSolitaryWave_Rayleigh
set name=CaseSolitaryWave_Boussinesq
rem set name=CaseSolitaryWave_KdV
...
%measuretool% -dirin %diroutdata% -points wg_x8.txt -onlytype:-all,+fluid -elevation -savecsv %dirout2%/eta_x8
if not "%ERRORLEVEL%" == "0" goto fail
