...
export name=CaseRZ_FlowCylinder3D
...
# Executes IsoSurface to create VTK files with isosurface.
export dirout2=${dirout}/iso
${isosurface} -dirin ${diroutdata} -saveiso ${dirout2}/iso 
if [ $? -ne 0 ] ; then fail; fi
