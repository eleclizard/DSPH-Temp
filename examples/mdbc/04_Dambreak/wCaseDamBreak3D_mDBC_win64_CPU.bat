...
%measuretool% -dirin %diroutdata% -points pressure.txt -onlytype:+all,+fluid -vars:-all,+press -kclimit:0.5 -savevtk %dirout2%/pressure -savecsv %dirout2%/_pressure 
if not "%ERRORLEVEL%" == "0" goto fail
