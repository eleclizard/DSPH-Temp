...
protected:
  ...
  float HeatKFluid; ///< Thermal conductivity array of fluid particles
  float HeatKBound; ///< Thermal conductivity array of boundary particles
...
protected:
  ...
  void AddBasicArrays(JDataArrays &arrays,unsigned np,const tdouble3 *pos
    ,const unsigned *idp,const tfloat3 *vel,const float *rhop,const double *temp)const;
